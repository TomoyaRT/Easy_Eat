      ...
      <div class="credit-card" @click="creditCardStatus = !creditCardStatus">
            <div class="flip" :class="{ 'flip-active': !creditCardStatus }">
                ...
                <div class="back">
                    ...
                    <div class="terms">
                        <p>This card is property of Monzo Bank, Wonderland. Misuse is criminal offence. If found, please
                            return to Monzo Bank or to the nearest bank with MasterCard logo.</p>
